...
export default function AdminHeader({ currentTab, onTabChange }: AdminHeaderProps) {
  const tabs = [
    { name: 'Overview', icon: <LayoutDashboard className="h-4 w-4 mr-2" />, path: '/admin' },
    { name: 'Users', icon: <Users className="h-4 w-4 mr-2" />, path: '/admin/users' },
    { name: 'Products', icon: <Package className="h-4 w-4 mr-2" />, path: '/admin/products' },
    { name: 'Orders', icon: <ShoppingBag className="h-4 w-4 mr-2" />, path: '/admin/orders' },
    { name: 'Analytics', icon: <BarChart className="h-4 w-4 mr-2" />, path: '/admin/analytics' },
    { name: 'Transactions', icon: <CreditCard className="h-4 w-4 mr-2" />, path: '/admin/transactions' },
    { name: 'Messages', icon: <MessageSquare className="h-4 w-4 mr-2" />, path: '/admin/messages' },
  ];
