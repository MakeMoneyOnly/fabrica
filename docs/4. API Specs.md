...
```json
{
  ...
  "data": {
    ...
    "paymentUrl": "https://app.telebirr.et/pay?token=xxx",
    ...
    "referrals": [
      {
        ...
        "monthlyCommission": 180.00, // 20% of 899 ETB
        "totalEarned": 540.00,
...
### 11.1 Telebirr Payment Webhook

**Endpoint:** `POST /api/webhooks/telebirr`  
**Auth:** Signature verification (x-telebirr-signature header)  
